...
export const USER_UPDATE_PASS = 'user/updatePass'
...
export const USER_GET_LST_TOKEN_NFT_OPENED = 'user/getListTokenNftOpened'
...
export const PREDICT_CHECK_EXPIRED = 'predict/checkExpired'
