<template>
  <div class="deposit_component deposit-mobile">
    ...
    <div>
      <h3 class="modal-title">{{ $t('predict_team.receive') }}</h3>
      <h3 class="modal-title">{{ $t('predict_team.title_receive') }}</h3>
      <ul>
        <li><h3 class="sub-title">{{ $t('predict_team.direct1') }}</h3></li>
        <li><h3 class="sub-title">{{ $t('predict_team.direct2') }}</h3></li>
      </ul>
      <el-form
        autocomplete="off"
        label-position="left">
