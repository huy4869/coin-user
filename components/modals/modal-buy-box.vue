  ...
  <div class="buy_box_component deposit_component deposit-mobile">
    ...
    <div>
      ...
      <ul>
        ...
        <li><h3 class="sub-title">{{ $t('buy_box.des2') }}</h3></li>
      </ul>
      <el-form
        autocomplete="off"
        label-position="left">
        <br/>
        <el-form-item class="" :label="$t('buy_box.wallet_address')">
          <el-input
            ref="walletAddress"
            :value="address || '0xa8944tgse4334524b00fc'"
            name="walletAddress"
            type="text"
            tabindex="2"
        ...
        <el-form-item class="" :label="$t('buy_box.memo')">
          <el-input
            ref="walletAddress"
            :value="memo || '0xa8944tgse4334524b00fc'"
            name="walletAddress"
            type="text"
            tabindex="2"
            class="address disabled-common"
